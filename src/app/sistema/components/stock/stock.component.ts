...
export class StockComponent {
    ...
    ngOnInit(): void {
        if (localStorage.getItem('stock_stockFechaFiltroDesde')) {
            this.fechaFiltroDesde = localStorage.getItem('stock_stockFechaFiltroDesde')!
        }
        if (localStorage.getItem('stock_stockFechaFiltroHasta')) {
            this.fechaFiltroHasta = localStorage.getItem('stock_stockFechaFiltroHasta')!
        }
    ...
    actualizarTabla(){
        this.cs.getAllPost(`operaciones/stock`, { 
    ...
    filtrar(){
        ...
        console.log(this.fechaFiltroDesde)
        console.log(this.fechaFiltroHasta)
        ...
        console.log(this.selectedLaboratorios)
    ...
    guardarFechas() {
        localStorage.setItem('stock_stockFechaFiltroDesde', this.fechaFiltroDesde)
        localStorage.setItem('stock_stockFechaFiltroHasta', this.fechaFiltroHasta)
